...
(function() {
  var AcidSynth, Delay, DrumSynth, NoiseHat, NoiseNode, Reverb, Sample, SampleList, SpreadSynth, WubSynth,
  ...
  Reverb = (function() {
    function Reverb(context) {
      ...
      this.convolver.buffer = AE.S.ir_t600.buffer;
  ...
  AE.Engine = (function() {
    function Engine(state) {
      ...
      AE.S = new SampleList(this.audioContext, this.postSampleInit);
      ...
      AE.DrumSynth = new DrumSynth(this.audioContext, this.noiseBuffer);
    ...
    Engine.prototype.getAnalyserData = function() {
      var analyserData;
